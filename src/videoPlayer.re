[%bs.raw {|require('./videoPlayer.css')|}];
...
let component = ReasonReact.reducerComponent "VideoPlayer";
...
let make _children => {
  ...component,
  initialState: fun () => {video: ref None, isPlayingVideo: false, isShowingModal: false},
